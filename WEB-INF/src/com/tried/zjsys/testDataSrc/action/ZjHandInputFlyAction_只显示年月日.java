...
@Controller
@Scope("prototype")
public class ZjHandInputFlyAction_只显示年月日 extends BaseAction<ZjHandInputFly> {
	private static Logger logger = Logger.getLogger(ZjHandInputFlyAction_只显示年月日.class);
